...
import com.gotechy.valentinedove.adapter.CardsCollectionPagerAdapter;

public class CardsActivity extends FragmentActivity {
	
	CardsCollectionPagerAdapter mCollectionPagerAdapter;
	ViewPager viewPager;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mCollectionPagerAdapter = new CardsCollectionPagerAdapter(getSupportFragmentManager(), getApplicationContext());
